      ...
      >
        <li>
          <Link
            to={{
              pathname: "/Alarm",
              state: { actualScreen: location.pathname, screenIndex: 0 },
            }}
            role="button"
            className="button"
          >
        ...
        <li>
          <Link
            to={{
              pathname: "/Clock",
              state: { actualScreen: location.pathname, screenIndex: 1 },
            }}
            role="button"
            className="button"
          >
        ...
        <li>
          <Link
            to={{
              pathname: "/Timer",
              state: { actualScreen: location.pathname, screenIndex: 2 },
            }}
            role="button"
            style={{ color: "white" }}
            className="button"
        ...
        <li>
          <Link
            to={{
              pathname: "/Stopwatch",
              state: { actualScreen: location.pathname, screenIndex: 3 },
            }}
            role="button"
            className="button"
          >
